...
void handlePanel(HTTPRequest *req, HTTPResponse *res) {
  ...
  res->print(generateDashboardHTML());
}
...
void setupDashboardRoutes() {
 secureServer.registerNode(new ResourceNode("/panel", "GET", [](HTTPRequest *req, HTTPResponse *res){
    handlePanel(req, res);
  }));
  secureServer.registerNode(new ResourceNode("/lamp/toggle", "POST", [](HTTPRequest *req, HTTPResponse *res){
    handleLampToggle(req, res);
  }));
  secureServer.registerNode(new ResourceNode("/motor/toggle", "POST", [](HTTPRequest *req, HTTPResponse *res){
    handleMotorToggle(req, res);
  })); 
}
